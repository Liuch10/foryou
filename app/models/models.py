...
class User(db.Model):
    ...
    user_city = db.Column(db.String(64), default="")
    user_hospital = db.Column(db.String(64), default="")
    user_department = db.Column(db.String(64), default="")
    user_title = db.Column(db.String(64), default="")
    user_phone = db.Column(db.String(64), default="")
    user_chain_address = db.Column(db.String(64), default="")
